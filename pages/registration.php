                        ...
                        <form action = "../user/signup.php" class="form" method="post">
                            ...
                            <div class="row">
                                <div class="u-s-m-b-30 col-lg-6">
                                    ...
                                    <input type="text" name="FirstName" id="FirstName" class="text-field" placeholder="First Name" required>
                                </div>
                                ...
                                <div class="u-s-m-b-30 col-lg-6">
                                    ...
                                    <input type="text" name="LastName" id="LastName" class="text-field" placeholder="Last Name" required>
                                </div>
                            </div>
                            ...
                            <div class="u-s-m-b-30">
                                ...
                                <input type="text" name="Address" id="address" class="text-field" placeholder="Address" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="u-s-m-b-30">
                                    ...
                                    <input type="text" name="City" id="city" class="text-field" placeholder="City" required>
                                </div>
                                ...
                                <div class="u-s-m-b-30">
                                    ...
                                    <input type="text" name="Region" id="region" class="text-field" placeholder="Region" required>
                                </div>
                            </div>
