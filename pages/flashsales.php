...
$flashSales = getActiveFlashSales($pdo, $sortBy, $sortOrder, $itemsPerPage, ($currentPage - 1) * $itemsPerPage);
$totalFlashSales = countActiveFlashSales($pdo);
$totalPages = ceil($totalFlashSales / $itemsPerPage);

function getActiveFlashSales($pdo, $sortBy, $sortOrder, $limit, $offset) {
    $now = date('Y-m-d H:i:s');
    
    $query = "SELECT * FROM flash_sales 
...
function countActiveFlashSales($pdo) {
    $now = date('Y-m-d H:i:s');
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM flash_sales WHERE start_date <= ? AND end_date >= ?");
    ...
    <div class="container">
        <div class="page-intro">
            ...
            <ul class="bread-crumb">
                ...
                <li class="is-marked">
                    <a href="./flash-sales.php">Flash Sales</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="page-deal u-s-p-t-80">
    <div class="container">
        <div class="deal-page-wrapper">
            <h1 class="deal-heading">Flash Sales</h1>
            <h6 class="deal-has-total-items"><?= $totalFlashSales ?> Items</h6>
        </div>
