        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <!-- Product-zoom-area -->
                    <div class="zoom-area">
                        <img id="zoom-pro" class="img-fluid" src="../assets/images/product/product@4x.jpg" data-zoom-image="images/product/product@4x.jpg" alt="Zoom Image">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="description">
                                <div class="description-whole-container">
                                    ...
                                    <img class="desc-img img-fluid u-s-m-b-26" src="../assets/images/product/product@3x.jpg" alt="Product">
                                    <iframe class="desc-iframe u-s-m-b-45" width="710" height="400" src="../assets/images/product/iframe-youtube.jpg" allowfullscreen></iframe>
                                </div>
                            </div>
                            <!-- Description-Tab /- -->
                            <!-- Specifications-Tab -->
