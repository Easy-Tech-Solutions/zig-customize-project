        ...
        <div class="container">
            <div class="page-intro">
                ...
                <ul class="bread-crumb">
                    ...
                    <li class="is-marked">
                        <a href="./lost-username.php">Lost Username</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="page-lost-password u-s-p-t-80">
        <div class="container">
            <div class="page-lostpassword">
                <h2 class="account-h2 u-s-m-b-20">Forgot Username ?</h2>
                <h6 class="account-h6 u-s-m-b-30">Enter your email to get your username</h6>
                <form action="../user/forgot_username.php" method="post">
                    <div class="w-50">
                        ...
                        <div class="u-s-m-b-13">
                            <button class="button button-outline-secondary" name="submit_username">Get Username</button>
                        </div>
                    </div>
