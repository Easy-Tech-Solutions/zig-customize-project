...
<head>
    ...
    <!-- Font Awesome 5 -->
    <link rel="stylesheet" href="../assets/acss/fontawesome.min.css">
    <!-- Ion-Icons 4 -->
    <link rel="stylesheet" href="../assets/acss/ionicons.min.css">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="../assets/acss/animate.min.css">
    <!-- Owl-Carousel -->
    <link rel="stylesheet" href="../assets/acss/owl.carousel.min.css">
    <!-- Jquery-Ui-Range-Slider -->
    <link rel="stylesheet" href="../assets/acss/jquery-ui-range-slider.min.css">
    <!-- Utility -->
    <link rel="stylesheet" href="../assets/acss/utility.css">
    <!-- Main -->
    <link rel="stylesheet" href="../assets/acss/bundle.css">
</head>
    ...
    <div class="page-404">
        <div class="vertical-center">
            <div class="text-center">
                <h1>404!</h1>
                <h5>We can't seem to find the page you're looking for. Please check the spelling.</h5>
