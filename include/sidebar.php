<div class="sidebar-menu-dashboard">
                    <a href="../index.html" class="logo-box">
                        <img src="../assets/images/main-logo/ZIG-logo.png" alt="">
                    </a>
                    <div class="user-box">
                        <p class="fw-6">Profile</p>
                        <div class="user">
                            <div class="icon-box profile-icon">
                                <img src="<?php echo $profile_image; ?>" alt="profile image" width="50px" height="50px"> 
                            </div>  
                            <div class="content">
                                <div class="caption-2 text">Profile</div>
                                <div class="text-white fw-6"><?php echo $customer_email; ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="menu-box">
                        ...
                        <ul class="box-menu-dashboard">
                            ...
                            <li class="nav-menu-item active">
                                <a class="nav-menu-link" href="./viewprofile.php">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g opacity="0.2">
