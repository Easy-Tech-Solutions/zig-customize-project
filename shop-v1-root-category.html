                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    ...
                    <div class="fetch-categories">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="shop-v3-sub-sub-category.html">Tank Tops
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v4-filter-as-category.html">Sweatshirts
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v4-filter-as-category.html">Hoodies
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v4-filter-as-category.html">Sweaters
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v4-filter-as-category.html">Crop Tops
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.html">Trousers
                                    <span class="total-fetch-items">(3)</span>
                                </a>
                            </li>
                            <!-- <li>
                        ...
                        <!-- Level-2 -->
                        <h3 class="fetch-mark-category">
                            <a href="shop-v2-sub-category.html">Headwears
                                <span class="total-fetch-items">(1)</span>
                            </a>
                        </h3>
                        <!-- Level-2 /- -->
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.html">Bucket Hats
                                    <span class="total-fetch-items">(0)</span>
                                </a>
                            </li>
                            <li>
                                <a href="shop-v2-sub-category.html">Face caps
                                    <span class="total-fetch-items">(1)</span>
                                </a>
                            </li>
                            <!-- <li>
                        ...
                        <!-- Level-2 -->
                        <h3 class="fetch-mark-category">
                            <a href="shop-v2-sub-category.html">Bags
                                <span class="total-fetch-items">(2)</span>
                            </a>
                        </h3>
                        <!-- Level-2 /- -->
                        ...
                        <ul>
                            <li>
                                <a href="shop-v3-sub-sub-category.html">Tote Bags
                                    <span class="total-fetch-items">(2)</span>
                                </a>
                            </li>
                            <!-- <li>
