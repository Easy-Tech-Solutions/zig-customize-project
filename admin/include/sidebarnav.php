<aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="../../index.php">
          <img src="../../assets/images/main-logo/ZIG-logo.png" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            <a
              ...
              class="collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#ddmenu_13"
              aria-controls="ddmenu_13"
              aria-expanded="false"
              aria-label="Toggle navigation"
            >
              <span class="icon">
              ...
              <span class="text">Deals and Promotions</span>
            </a>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text">Security and Privacy</span>
            </a>
